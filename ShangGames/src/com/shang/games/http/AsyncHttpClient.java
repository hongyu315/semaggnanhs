...
public class AsyncHttpClient {
	...
	private static int socketTimeout = DEFAULT_SOCKET_TIMEOUT * 3;
	...
	public AsyncHttpClient() {
		...
		DefaultHttpRequestRetryHandler retryHandler = new DefaultHttpRequestRetryHandler(DEFAULT_MAX_RETRIES, true);
